...
#
# Generated by export_simulation on Sun Jul 14 01:31:07 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './vio_user_encoder.sh' script.

./vio_user_encoder.sh -reset_run
...
./vio_user_encoder.sh -noclean_files

For more information on the script, please type './vio_user_encoder.sh -help'.
