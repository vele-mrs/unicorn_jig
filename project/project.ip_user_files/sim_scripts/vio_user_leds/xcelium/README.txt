...
#
# Generated by export_simulation on Sat Jul 13 16:43:01 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './vio_user_leds.sh' script.

./vio_user_leds.sh -reset_run
...
./vio_user_leds.sh -noclean_files

For more information on the script, please type './vio_user_leds.sh -help'.
