...
#
# Generated by export_simulation on Sat Jul 13 18:10:29 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './ila_user_input.sh' script.

./ila_user_input.sh -reset_run
...
./ila_user_input.sh -noclean_files

For more information on the script, please type './ila_user_input.sh -help'.
