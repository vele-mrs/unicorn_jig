...
#
# Generated by export_simulation on Sun Jul 14 00:54:48 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './ila_user_encoder.sh' script.

./ila_user_encoder.sh -reset_run
...
./ila_user_encoder.sh -noclean_files

For more information on the script, please type './ila_user_encoder.sh -help'.
