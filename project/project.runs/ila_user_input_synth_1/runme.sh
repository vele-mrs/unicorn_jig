...
HD_PWD='C:/Users/vele/Desktop/Workspace/Project_FPGA/unicorn_jig/project/project.runs/ila_user_input_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_user_input.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_user_input.tcl
