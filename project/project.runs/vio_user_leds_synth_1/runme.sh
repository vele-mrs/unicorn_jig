...
HD_PWD='C:/Users/vele/Desktop/Workspace/Project_FPGA/unicorn_jig/project/project.runs/vio_user_leds_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_user_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_user_leds.tcl
